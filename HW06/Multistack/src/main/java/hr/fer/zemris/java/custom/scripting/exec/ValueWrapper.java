...
/**
 * Class which wraps the elements which go into the ObjectMultistack as MultistackEntries.
 * Works with Integer, Double and String classes.
 * 
 * @author Goran Brlas
 * @version 1.0
 *
...
public class ValueWrapper {
	...
	/**
	 * Constructor which sets the wrapper value to the provided one.
	 * If the provided value is null, initial value is set to Integer value of 0.
	 * @param value Value to be set as initial wrapper value.
	 */
	 ...
	 * @param incValue Value to add to the wrapper value.
	 */
	 ...
	 * @param decValue Value to add to the wrapper value.
	 */
	 ...
	 * @param mulValue Value to be multiplied with the wrapper value.
	 */
	 ...
	 * @param divValue Value to divide the wrapper value by.
	 */
	 ...
	 * @param withValue Wrapper to be compared with the caller.
	 * @return Integer larger than 0 if the caller is bigger, Integer lower than 0 if caller is smaller, Integer value of 0 otherwise.
	 */
	...
	/**
	 * Helps decide the class types and passes the values to the processing methods.
	 * @param value2 Value to be processed accordingly.
	 * @param operation Caller of the method.
	 * @return Object representing the final result of the caller operation
	 * @throws RuntimeException - if invalid value stored in the wrapper.
	 */
	private Object decideClassType(Object value2, int operation) {
		...
		try {
			...
			if (value.getClass().equals(value2.getClass())) {
				...
				if (value2 instanceof Integer) {
					value2 = Double.valueOf((double) ((Integer) value2).intValue());
					temp = processDouble(value2, operation);
				...
				if (value2 instanceof Double) {
					value = Double.valueOf((double) ((Integer) value).intValue());
					temp = processDouble(value2, operation);
				} else if (value2 instanceof String) {
					value2 = ((String) value2).replace(',', '.');
					if (((String) value2).contains("E") || ((String) value2).contains(".")) {
						value2 = Double.parseDouble((String) value2);
						value = Double.valueOf((double) ((Integer) value).intValue());
						temp = processDouble(value2, operation);
					} else {
	 ...
	 * @param value2 Value to be processed with accordingly.
	 * @param operation Caller of the method.
	 * @return Object representing the final result of the caller operation
	 * @throws IllegalArgumentException - if dividing by zero.
	 */
	private Object processDouble (Object value2, int operation) {
		double temp1 = ((Double) value).doubleValue();
		double temp2 = ((Double) value2).doubleValue();
		Double result = null;
	 ...
	 * @throws IllegalArgumentException - if dividing by zero.
	 */
	private Object processInteger (Object value2, int operation) {
		int temp1 = ((Integer) value).intValue();
		int temp2 = ((Integer) value2).intValue();
		Integer result = null;
	 ...
	 * @return Object representing the final result of the caller operation
	 */
	private Object processString (Object value2, int operation) {
		if (((String) value2).contains(".") || ((String) value2).contains("E")
			|| ((String) value).contains(".") || ((String) value).contains("E")
			|| ((String) value2).contains(",") || ((String) value2).contains(",")) {
