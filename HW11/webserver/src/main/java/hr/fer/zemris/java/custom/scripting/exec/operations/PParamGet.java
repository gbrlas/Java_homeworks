...
/**
 * Class which obtains from requestContext's persistent parameters map a value
 ...
 *
 */
public class PParamGet implements Operations {
	@Override
	public void execute(final Stack<ValueWrapper> temporaryStack,
		...
		final String value = rc.getPersistentParameter(((String) name
				.getValue()).replace("\"", "").trim());
