...
/**
 * Class which obtains from RequestContext's parameters map a value mapped for
 * name and pushes it onto stack. Pops two arguments from the stack, does the
 ...
 *
 */
public class ParamGet implements Operations {
	@Override
	public void execute(final Stack<ValueWrapper> temporaryStack,
		...
		final String value = rc.getParameter(((String) name.getValue())
				.replace("\"", "").trim());
